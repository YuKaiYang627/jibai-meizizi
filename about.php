  ...
  <main id="main">
            ...
            <div class="skills-content">
              ...
              <div class="progress">
                ...
                <div class="progress-bar-wrap">
                  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="93" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
              ...
              <div class="progress">
                ...
                <div class="progress-bar-wrap">
                  <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="row" style="padding-center: 228px;">

          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="assets/img/team/haha.jpg" class="img-fluid" alt="" style="height: 198px;">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/Luo fung.jpeg" class="img-fluid" alt="" style="height: 198px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Wong Luo Fung</h4>
                </div>
